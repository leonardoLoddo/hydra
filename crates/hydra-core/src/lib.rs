...
pub use head::{
    ...
    HeadError, HeadInspection, HeadSummary, IntegrationResult, IntegrationStrategy, OpenedHead,
    ProjectInspection, RemoveHeadOptions, RemovedHead, RepairIssue, RepairPlan, RepairResult,
    WorktreeHead, apply_repairs, close_head, create_head, create_head_with_progress, head_path,
    inspect_head, inspect_project, list_heads, open_head, plan_repairs, remove_head,
};
