...
| [`head-close.md`](head-close.md) | `hydra head close`, fast-forward or merge integration, target-ref updates, conflict preservation, checked-out or dirty targets, invocation from a Head, or removal after integration | Implemented close transaction, dynamic clean-target-worktree or checkout-free integration, target publication, conflict behavior, and protected-removal composition. |
