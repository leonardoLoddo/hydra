...
| any: Rust code or test, code review, bug fix, refactor, dependency, Cargo configuration, quality gate, platform-specific implementation, unsafe boundary, regression assessment | required | [rust-tdd-context.md](rust-tdd-context.md) | the change is documentation-only and cannot affect compiled or runtime behavior |
