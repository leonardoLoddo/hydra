...
| [`agent-skills.md`](agent-skills.md) | Installing, invoking, updating, removing, packaging, or explaining Hydra's optional Agent Skill across supported providers | English human guide for the provider-specific skill lifecycle and shared operating boundary. |
