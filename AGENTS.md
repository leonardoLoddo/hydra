...
2. Project documentation routed from [`Docs/ai/ROUTER.md`](Docs/ai/ROUTER.md).
...
`.agents/skills/librairian/SKILL.md`. If unavailable, follow the repository-local
protocol through the Governance route in `Docs/ai/ROUTER.md`. Resolve explicit
inherited defaults when consulting the selected leaves.
...
Human-facing documentation remains under `Docs/user/` outside the active
